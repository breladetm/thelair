        ...
        banSchema.findOne({ User: interaction.user.id }, async (err, data) => {
            if (data) {
                return interaction.reply({
                    content: "I encountered an error when trying to run this command. Please join our [support server](https://www.discord.gg/dRjem9kKhU) for more information.",
                    ephemeral: true
                });
            }            
            else {
