...
module.exports = (client) => {
    ...
    client.errUsage = async function ({
        ...
        embed.setDescription(`Your arguments are incorrect`)
        embed.addFields(
            { name: "The required arguments are:", value: `\`\`\`${usage}\`\`\``},    
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errMissingPerms = async function ({
        ...
        embed.setTitle(`Error`)
        embed.setDescription(`You don't have the necessary permissions.`)
        embed.addFields(
            { name: "You need these permissions:", value: `\`\`\`${perms}\`\`\``},
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errNoPerms = async function ({
        ...
        embed.setTitle(`Error`)
        embed.setDescription(`I don't have the necessary permissions`)
        embed.addFields(
            { name: "I need these permissions:", value: `\`\`\`${perms}\`\`\``},
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errWait = async function ({
        ...
        embed.setDescription(`Try again in <t:${time}:f>`)
        embed.setColor(client.config.colors.error)
